...
.curso-main-container.pb-3
  ...
  .container.tarjeta.tarjeta--blanca.p-4.p-md-5.mb-5
    ...
    .row.justify-content-center.align-items-center.mb-4           
      ...
      .col-lg-9.my-3
        p(data-aos="fade-down") Partamos de la premisa de que una red de datos es tan sólida como lo es su eslabón más débil y, que generalmente, la capa 2 del modelo OSI se presenta como ese eslabón en las redes de datos. Esto representa para el administrador de la red un reto específico en la labor de monitoreo.

        p(data-aos="fade-down") La monitorización de redes informáticas ha surgido como una norma obligatoria para mantener en óptimas condiciones este recurso tecnológico. Supervisar la red de datos es un proceso mediante el cual los encargados de dicho proceso escudriñan periódicamente componentes tales como enrutadores, conmutadores, servidores, etc., en busca de posibles fallos de funcionamiento que puedan distorsionar las tareas fundamentales de la red de información.   
